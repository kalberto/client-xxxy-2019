(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/web/cliente~js/web/predio~js/web/prospeccao"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    removeMasks: function removeMasks(masks) {
      var _this = this;

      masks.forEach(function (mask) {
        if (lodash__WEBPACK_IMPORTED_MODULE_0___default.a.get(_this.$data, mask)) lodash__WEBPACK_IMPORTED_MODULE_0___default.a.set(_this.$data, mask, lodash__WEBPACK_IMPORTED_MODULE_0___default.a.get(_this.$data, mask).replace(/\D/gi, ''));
      });
