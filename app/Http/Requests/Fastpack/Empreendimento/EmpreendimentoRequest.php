...
class EmpreendimentoRequest extends Request
{
	...
	public function rules()
	{
		...
		return [
			...
			'cliente_documento' => ['required', 'min:8', 'max:14','exists:clientes,documento'],
		];
	}
	...
	public function messages()
	{
		return [
				...
				'contato.*.email.regx' => 'Não é permitido espaço em branco.',
			];
	}
}
