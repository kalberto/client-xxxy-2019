(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/web/cliente~js/web/clientes-listagem~js/web/predio~js/web/predios-listagem~js/web/prospeccoes-lis~67249b2d"],{
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "button", class: { animate: _vm.$props.buttonIcon } },
    [
      _c(
        "button",
        {
